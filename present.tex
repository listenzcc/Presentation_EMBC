...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.17]{figures/design.png}
            \caption{Time line}
        \end{figure}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.15]{figures/raws/75yo_male.png}
            \caption{MRI image}
        \end{figure}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.12]{figures/sphx_glr_plot_eeg_no_mri_001.png}
            \caption{Alignment}
        \end{figure}
